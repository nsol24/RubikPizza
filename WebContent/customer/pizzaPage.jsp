			...
			<div class="col-md-3 my-3">
				<div class="card w-100">
					...
					<div class="card-body">
						...
						<h6 class="category">Description: <%=m.getDesc() %></h6>
						<div class="mt-3 d-flex justify-content-between">
							<a class="btn btn-dark" href="CartController?id=<%= m.getId() %>">Add to Cart</a> <a
								class="btn btn-primary" href="order-now?quantity=1&id=<%=m.getId()%>">Buy Now</a>
						</div>
					</div>
				</div>
			</div>
