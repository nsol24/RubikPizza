 	...
 	<form action="UpdateStaffController" method="post" class="needs-validation" novalidate style="max-width: 800px; margin: 0 auto;">
      <div class="row g-3">
        <div class="col-sm-6">
          ...
          <input type="text" class="form-control" id="id" name="rider_id" value="<c:out value="${rider.id}" />" readonly>
          <div class="invalid-feedback"> Valid id number is required. </div>
        </div>
        
        <div class="col-12">
          <label for="staff_name" class="form-label">Full name</label>
          <input type="text" class="form-control" id="staff_name" name="rider_name" value="<c:out value="${rider.name}" />" required>
          <div class="invalid-feedback"> Valid full name is required. </div>
        </div>
        <div class="col-6">
          <label for="staff_email" class="form-label">Email</label>
          <input type="email" class="form-control" id="staff_email" name="rider_email" value="<c:out value="${rider.email}" />" required>
          <div class="invalid-feedback"> Valid email address is required. </div>
        </div>
        <div class="col-6">
          <label for="staff_phonenum" class="form-label">Phone number</label>
          <input type="text" class="form-control" id="staff_phonenum" name="rider_phonenum" value="<c:out value="${rider.phone}" />" required>
