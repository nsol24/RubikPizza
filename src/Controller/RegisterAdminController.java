...
import Model.Admin;
import Model.Rider;
@WebServlet("/admin/RegisterAdminController")
public class RegisterAdminController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int user_id = (Integer.parseInt(request.getParameter("adminid")));
		int manager_id = (Integer.parseInt(request.getParameter("mgrid")));
